...
namespace Dwellers.Household.Infrastructure.Repositories.Authentication
{
    public class JwtTokenRepository : IJwtTokenRepository
    {
        ...
        public async Task<string> GenerateToken(User user, Guid houseId)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddDays(1), // Set the token expiration time as needed
